        ...
        <>
            ...
            >
                <ul className="nav flex-column text-white w-100">
                    ...
                    <li href="#" className="nav-link m-2">
                        ...
                        >
                            ...
                            <img src={image2} alt="" />
                            <span className="mx-2 hide-at-small">
                                {" "}
                                Connect Profiles
                            </span>
                            {navbarToggle && (
                ...
                <span href="#" className="text-center h4 w-100 mb-5">
                    <button
                        className="btn btn-danger text-center px-3 py-2"
            ...
            <div
                className={`p-1 my-container ${
                    navbarToggle ? "active-cont" : ""
                }`}
            >
                <nav
                    className="navbar top-navbar navbar-light fixed-top bg-white px-3"
                ...
                >
                    <span className="nav-title">
                        ...
                        >
                            ...
                            <span className="h2 hide-at-small">
                                {props.NavTitle}
                            </span>
                        </span>
                    </span>
